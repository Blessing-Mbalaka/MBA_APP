...
const spanClasses = [
  ...
  "bg-purple-100 text-purple-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-purple-900 dark:text-purple-300",
...
document.addEventListener('DOMContentLoaded', function (){ 
    ...
    for (let tag of tags) {
        let idx = Math.floor(Math.random() * spanClasses.length)
       tag.classList.add(...spanClasses[idx].split(" "))
    }
